...
#awk '{ if ($5 == " Consorzio" ) print $1, $2"-C", $3, $4; else print $1, $2, $3, $4 }' ${d}mp123_$nome_a.txt > ${d}mp123_$nome.txt 
...
scp /cygdrive/d/grassworks/scambio/8545.jpeg.png idroweb@172.16.1.11:/var/www/idro/manual
cat ${d}grassin3.sh | /usr/local/bin/grass62 -text /cygdrive/d/grassworks/gb/MISURE/
rm  ${d}gisinput_*.txt
